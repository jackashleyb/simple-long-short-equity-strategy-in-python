...
A quantitative trading strategy project built in Python. This project implements a stratgy of going long on underperforming stocks and short on overperforming ones, aiming to capture mean reversion (SPY, META, GOOGL, MSFT).
